...
$classes = Flux::classes()
    ->add('w-full border rounded-lg block')
    ...
    ->add(match ($variant) { // Border...
        'outline' => 'border-zinc-200 border-b-zinc-300/80 disabled:border-b-zinc-200 dark:border-white/10 dark:disabled:border-white/5',
        'filled'  => 'border-0',
    })
