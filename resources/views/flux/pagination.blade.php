...
@if ($simple)
    <div {{ $attributes->class('pt-4 border-t border-zinc-100 dark:border-zinc-700 flex justify-between items-center') }} data-flux-pagination>
        <div></div>
...
@else
    <div {{ $attributes->class('@container pt-4 border-t border-zinc-100 dark:border-zinc-700 flex justify-between items-center gap-3') }} data-flux-pagination>
