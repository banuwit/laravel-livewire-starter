...
$classes = Flux::classes()
    ...
    ->add('in-data-flux-sidebar-collapsed-desktop:w-8 in-data-flux-sidebar-collapsed-desktop:justify-center')
    ->add('py-0 text-start w-full px-3 has-data-flux-navlist-badge:not-in-data-flux-sidebar-collapsed-desktop:pe-1.5 my-px')
    ->add('text-white/70 dark:text-white/80')
    ->add(match ($accent) {
        true => [
            'data-current:text-white hover:data-current:text-white',
            'data-current:bg-white/40 dark:data-current:bg-white/[7%]',
            'hover:text-white dark:hover:text-white dark:hover:bg-white/[7%] hover:bg-white/10 ',
...
<flux:tooltip :position="$tooltipPosition" class="in-data-flux-sidebar-collapsed-desktop:mx-auto">
