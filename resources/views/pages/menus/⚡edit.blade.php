...
<div class="flex flex-col gap-6">
    ...
    <form wire:submit="updateMenu" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {{-- Right wide: Tabs --}}
        ...
        <div class="flex flex-col gap-6 lg:order-1">
            ...
            <flux:card class="space-y-3">
                <flux:button variant="primary" type="submit" class="w-full" icon="check">Update Menu</flux:button>
