...
<div class="flex flex-col gap-6">
    ...
    <form wire:submit="createRole" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="flex flex-col gap-6 lg:order-1">
            ...
            <flux:card class="space-y-3">
                <flux:button variant="primary" type="submit" class="w-full" icon="check">Create Role</flux:button>
