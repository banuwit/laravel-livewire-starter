    ...
    <div class="flex items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col">
                ...
                <flux:text variant="muted">Define a new role and assign its permissions.</flux:text>
            </div>
        </div>
        <div class="flex items-center gap-2">
            <flux:button wire:navigate href="{{ route('roles.index') }}" variant="ghost">Cancel</flux:button>
            <flux:button type="submit" form="save-form" variant="primary" icon="check">Create Role</flux:button>
        </div>
    </div>

    <form id="save-form" wire:submit="createRole" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <flux:card class="lg:col-span-2 lg:order-2">
            <div class="flex flex-col gap-5">
                ...
                <flux:tab.group>
                    ...
                    @foreach ($menuGroups as $layout => $menus)
                        <flux:tab.panel name="{{ $layout }}" class="space-y-2 pr-1">
